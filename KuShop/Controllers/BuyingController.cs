    ...
    public class BuyingController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var pd = from b in _db.Buyings
                     join s in _db.Suppliers on b.SupId equals s.PubId into join_b_s
        ...
        public IActionResult Create()
        {
            ...
            ViewData["Sup"] = new SelectList(_db.Suppliers, "PubId", "PubName");
            return View();
        }
        ...
        public IActionResult Show(string buyid)
        {
            ...
            foreach (var s in buying)
            {
                ...
                ViewBag.SupName = _db.Suppliers.FirstOrDefault(sp => sp.PubId == s.SupId).PubName;
            }
        ...
        public IActionResult Edit(string buyid)
        {
            ...
            ViewData["PubId"] = new SelectList(_db.Suppliers, "PubId", "PubName", obj.SupId);
            return View(obj);
        }
